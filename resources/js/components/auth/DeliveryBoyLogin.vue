  ...
  <div class="
    ...
    >
      ...
      >
        <banner
          :loading="false"
          :banner="$store.getters['app/banners'].delivery_boy_login_page"
          class="mt-5 mt-lg-0"
        />
      </v-col>
      <v-col
      ...
      >
        <div class="px-lg-7">
          ...
          >
            <div
              v-if="authSettings.customer_login_with == 'email' || (!showPhoneField && authSettings.customer_login_with == 'email_phone')"
              class="mb-4"
            >
            ...
            <div
              v-if="authSettings.customer_login_with == 'phone' || (showPhoneField && authSettings.customer_login_with == 'email_phone')"
              class="mb-4"
            >
              <div class="mb-1 fs-13 fw-500">
                {{ $t("phone_number") }}
      ...
      if (res.data.success) {
        if (
          ...
          this.$router.push(
            ...
            this.$route.query.redirect || { name: "DeliveryBoyDashboard" }
          );
        } else {
          if (
            this.authSettings.customer_login_with == "email" ||
