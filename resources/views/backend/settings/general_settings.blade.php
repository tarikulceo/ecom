        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-6 col-from-label">{{ translate('Pickup Point Activation') }}</label>
                        <div class="col-sm-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-6 col-from-label">{{ translate('Delivery Boy') }}</label>
                        <div class="col-sm-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="updateSettings(this, 'delivery_boy')"
                                    <?php if (get_setting('delivery_boy') == 1) {
                                        echo 'checked';
                                    } ?>>
                                <span class="slider round"></span>
                            </label>
                    ...
                    @if (addon_is_activated('multi_vendor'))
                        ...
                        <div class="form-group row">
                            <label
                                class="col-sm-6 col-from-label">{{ translate('Seller Order Manage By Admin') }}</label>
                            <div class="col-sm-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-6 col-from-label">{{ translate('Support Chat') }}</label>
                        <div class="col-sm-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
