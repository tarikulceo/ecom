...
<section class="gry-bg pb-4 profile">
                    ...
                    <div class="row gutters-5 mb-3">
                        <div class="col-md-6 mb-2 mb-md-0">
                            <div class="form-group mb-0">
                                <input class="form-control form-control-lg" type="text" name="keyword" placeholder="Search by Product Name" onkeyup="filterProducts()">
                            </div>
                        </div>
                                                ...
                                                <div class="row gutters-15 align-items-center">
                                                    <div class="col-auto w-60px px-0">
                                                        <div class="row ml--10 align-items-center flex-column aiz-plus-minus">
                                                            ...
                                                            <input type="text" name="qty-{{ $key }}" id="qty-{{ $key }}" class="col border-0 text-center flex-grow-1 fs-16 input-number py-1" placeholder="1" value="{{ $cartItem['quantity'] }}" min="{{ $product_variation->product->min_qty }}" max="{{ $product_variation->qty }}" onchange="updateQuantity({{ $key }})">
