...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card mb-0  px-4 py-5  p-5 h-100  d-flex align-items-center justify-content-center">
    ...
    <div>
        ...
        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="7" data-xl-items="6" data-lg-items="4"
            ...
            @foreach (\App\Models\Product::where('shop_id', Auth::user()->shop_id)->where('published', 1)->where('approved', 1)->orderBy('num_of_sale', 'desc')->limit(12)->get()
        as $key => $product)
