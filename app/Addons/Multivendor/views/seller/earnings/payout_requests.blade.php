    ...
    <div class="modal fade" id="withdraw_request_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                @if (Auth::user()->shop->current_balance > get_setting('min_withdrawal_amount'))
                ...
                @else
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="p-5 heading-3">
                            {{ translate('You do not have enough balance to send withdraw request. Minimum withdrawal balance is ' ) }} {{format_price(get_setting('min_withdrawal_amount'))}}
                        </div>
                    </div>
                @endif
            </div>
