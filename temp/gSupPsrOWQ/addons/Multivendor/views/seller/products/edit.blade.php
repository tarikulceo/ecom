        ...
        <div class="row gutters-5">
            <div class="col-lg">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="max_qty" value="{{ $product->max_qty }}"
                                    min="0">
                                <small
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            $price = !$product->is_variant ? optional($first_variation)->price : 0;
                            $sku = !$product->is_variant ? optional($first_variation)->sku : null;
                            $stock = !$product->is_variant ? optional($first_variation)->stock : 1;
                        @endphp
                        ...
                        <div class="no_product_variant" @if ($product->is_variant) style="display:none;" @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="test" placeholder="{{ translate('SKU') }}"
                                        value="{{ $sku }}" name="sku" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                @forelse (generate_variation_options($product->variation_combinations) as $key => $combination)
                                    <div class="form-group row gutters-10 ">
                                        ...
                                        <div class="col attr-values">
                                            @php
                                                $attribute_values = \App\Models\AttributeValue::where(
                                                    'attribute_id',
                                                    $combination['id'],
                                                )->get();
                                        ...
                                        @else
                                            <div class="col-auto">
                                                <button type="button" data-toggle="remove-parent"
                                                    class="btn btn-icon p-0" data-parent=".row" onclick="update_sku()">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="standard_delivery_time"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="express_delivery_time"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">{{ translate('These attributes will be used only for filtering.') }}
                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <input type="number" lang="en" min="0" value="{{ $tax_amount }}"
                                        step="0.01" placeholder="{{ translate('Tax') }}" name="taxes[]"
                                        class="form-control" required>
                                </div>
                                <div class="form-group col-6">
    ...
    <script type="text/javascript">
        ...
        function add_new_attribute() {
            $.ajax({
                ...
                url: '{{ route('seller.product.new_attribute') }}',
        ...
        function get_attributes_values(e) {
            $.ajax({
                ...
                url: '{{ route('seller.product.get_attribute_values') }}',
                success: function(data) {
        ...
        function add_new_option() {
            $.ajax({
                type: "POST",
                data: $('#product_form').serialize(),
                url: '{{ route('seller.product.new_option') }}',
                success: function(data) {
                    if (data.count == -2) {
        ...
        function get_option_choices(e) {
            $.ajax({
                ...
                url: '{{ route('seller.product.get_option_choices') }}',
                success: function(data) {
                    $(e).closest('.row').find('.attr-values').html(data);
                    AIZ.plugins.bootstrapSelect();
                }
        ...
        function update_sku() {
            $.ajax({
                type: "POST",
                url: '{{ route('seller.product.sku_combination') }}',
                data: $('#product_form').serialize(),
                success: function(data) {
