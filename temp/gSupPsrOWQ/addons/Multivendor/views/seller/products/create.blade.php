...
@section('content')
    ...
    <form class="form form-horizontal mar-top" action="{{ route('seller.product.store') }}" method="POST"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="height"
                                        min="0" required>
                                    <div class="input-group-append"><span
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="number" value="0" class="form-control" name="width"
                                        min="0" required>
                                    <div class="input-group-append"><span
                                            class="input-group-text">{{ get_setting('dimension_unit') }}</span></div>
                                </div>
        ...
        <div class="mar-all text-right mb-3">
            <button type="submit" class="btn btn-primary"
                id="upload-product">{{ translate('Upload Product') }}</button>
        </div>
    </form>
@endsection
